...
// não precisa indicar no Android Manifest
class ListaNoticiasFragment : Fragment() {
    ...
    var quandoFabSalvaNoticiaClicado: () -> Unit = {} // função vazia que não faz nada e pode ser sobreescrita
    var quandoNoticiaSeleciona: (noticia: Noticia) -> Unit = {}

    // não cria a view, apenas para inicializações
